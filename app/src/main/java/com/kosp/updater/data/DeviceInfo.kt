...
private const val PROP_DEVICE = "ro.kosp.build.device"
private const val PROP_DATE = "ro.build.date.utc"
private const val PROP_VERSION = "ro.kosp.build.version"
...
private const val PROP_FLAVOR = "ro.kosp.build.flavor"
