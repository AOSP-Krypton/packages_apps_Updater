...
import com.kosp.updater.data.update.UpdateState
...
class UpdateInstallerService : LifecycleService() {
    ...
    companion object {
        ...
        private const val ACTION_CANCEL_UPDATE = "com.kosp.updater.action.CANCEL_UPDATE"
        private const val ACTION_REBOOT = "com.kosp.updater.action.REBOOT"
        private const val ACTION_CANCEL_AUTO_REBOOT = "com.kosp.updater.action.CANCEL_AUTO_REBOOT"
